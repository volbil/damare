...
# ────────────────────────────────────────────────────────────────────────
# Home — "Топ тижня" leaderboard (10 items, home shows 7)
# ────────────────────────────────────────────────────────────────────────

TOP_WEEK = [
    {"rank": 1,  "id": "tysha",        "title": "Тиша між поверхами",                "author": "Леся Тарнавська",        "score": 9.4, "votes": 2814, "trend": "↑2",  "is_translation": False, "source_language": None},
    {"rank": 2,  "id": "kultivator",   "title": "Культиватор з обкладинки журналу",  "author": "Дочки Темряви",          "score": 9.2, "votes": 4120, "trend": "=",   "is_translation": True,  "source_language": "zh"},
    {"rank": 3,  "id": "sirko",        "title": "Сірко повертається додому",         "author": "Перекл. «Смолоскип»",    "score": 9.1, "votes": 1980, "trend": "NEW", "is_translation": True,  "source_language": "ja"},
    {"rank": 4,  "id": "house-dragon", "title": "Те, що ми залишаємо собі",          "author": "lesia.writes",           "score": 8.9, "votes": 3210, "trend": "↑5",  "is_translation": False, "source_language": None},
    {"rank": 5,  "id": "aurum",        "title": "Аурум, або Записки з провінції",    "author": "Олена Шкарупа",          "score": 8.8, "votes": 1660, "trend": "↓1",  "is_translation": False, "source_language": None},
    {"rank": 6,  "id": "mosaika",      "title": "Мозаїка для тих, хто запізнився",   "author": "Іван Дрозд",             "score": 8.7, "votes": 1402, "trend": "↑1",  "is_translation": False, "source_language": None},
    {"rank": 7,  "id": "instr-sun",    "title": "Інструкція з вимкнення сонця",      "author": "Аркадій Чорнохліб",      "score": 8.6, "votes": 4820, "trend": "↓2",  "is_translation": True,  "source_language": "en"},
    {"rank": 8,  "id": "pelyna",       "title": "Полин на крижаному вітрі",          "author": "Тарас Лимар",            "score": 8.5, "votes": 1140, "trend": "=",   "is_translation": False, "source_language": None},
    {"rank": 9,  "id": "kyrylytsya",   "title": "Кирилицею з Берліна",               "author": "Дочки Темряви",          "score": 8.4, "votes":  920, "trend": "↑3",  "is_translation": True,  "source_language": "de"},
    {"rank": 10, "id": "dim-pereiezh", "title": "Дім, у якому всі переїжджають",     "author": "Ярина Свіжак",           "score": 8.3, "votes": 2110, "trend": "↓3",  "is_translation": False, "source_language": None},
]


# ────────────────────────────────────────────────────────────────────────
# Home — "Гаряче зараз" cards. signal_kind drives icon + accent color:
#   burst    → +chapters, recent activity (accent)
#   momentum → ↑% audience, rising trend (info blue)
#   storm    → comment storm, hot discussion (love red)
#   finale   → final chapter, completion (neutral)
# ────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────
# Home — "Свіжі коментарі". Surfaces social energy on the home page.
# ────────────────────────────────────────────────────────────────────────
